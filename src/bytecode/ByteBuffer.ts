...
export class ByteBuffer {
  ...
  private _byteCursor = 0
  public get byteCursor(): number { return this._byteCursor }
  ...
  public setByteCursor(pos: number): void {
    this._byteCursor = pos
  }
  public discardStackBytes(bytes: number): void {
    this._byteCursor -= bytes
  }

  public backpatch(targetPosition: number, callback: () => void): void {
  ...
  public pushUint8(value: number): void {
  ...
  public pushInt8(value: number): void {
  ...
  public pokeUint8At(bytePos: number, value: number): void {
    this.dataView.setUint8(bytePos, value)
  }
  public pokeUint16At(bytePos: number, value: number): void {
    this.dataView.setUint16(bytePos, value)
  }
  public pokeUint32At(bytePos: number, value: number): void {
    this.dataView.setUint32(bytePos, value)
  }
  public pokeInt8At(bytePos: number, value: number): void {
    this.dataView.setInt8(bytePos, value)
  }
  public pokeInt16At(bytePos: number, value: number): void {
    this.dataView.setInt16(bytePos, value)
  }
  public pokeInt32At(bytePos: number, value: number): void {
    this.dataView.setInt32(bytePos, value)
  }
  public pokeFloat32At(bytePos: number, value: number): void {
    this.dataView.setFloat32(bytePos, value)
  }
  public pokeFloat64At(bytePos: number, value: number): void {
    this.dataView.setFloat64(bytePos, value)
  }

  public dumpStackTop(count = 3): Array<string> {
